...
@NgModule({
  declarations: [
    ...
    AddEventComponent,
    EventsEmployeeComponent,
    EventInfosComponent,
    EventsCalendarComponent,
    EventCalendarInfosComponent,
    EventRatingComponent,
    EmployeeSpaceComponent,
    CompanySpaceComponent,
    RatingsComponent,
    CategoryComponent,
    EmployeeFavoritesComponent,
    InvitedEmployeesComponent,
    EmployeeEventsInvitationsComponent,
    PublicEventsComponent,
    PrivateEventsComponent,
    PrivateEmployeeEventsComponent,
