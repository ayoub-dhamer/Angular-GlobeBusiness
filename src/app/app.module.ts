...
@NgModule({
  ...
  imports: [BrowserModule,MatPaginatorModule, RecaptchaModule, MatInputModule, AppRoutingModule,MatFormFieldModule, SwiperModule , HttpClientModule, BrowserAnimationsModule,MatTableModule],
  providers: [],
